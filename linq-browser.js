(function (global, factory) {
  ...
  exports.empty = empty;
  var marked0$0 = [genSubSequences, genTwoMergedSequence, genPairMergedSequences, genMergedAndSortedSequence].map(regeneratorRuntime.mark);
  ...
  function genSubSequences(seq, comp, compGroupChecker) {
    ...
    return regeneratorRuntime.wrap(function genSubSequences$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          lastVal = undefined;
          subSeq = undefined;
          _iterator = seq, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();
  ...
  function genTwoMergedSequence(seq1, seq2, comp) {
    ...
    return regeneratorRuntime.wrap(function genTwoMergedSequence$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          seqIter1 = seq1[Symbol.iterator]();
          seqIter2 = seq2[Symbol.iterator]();
          elem1 = seqIter1.next();
          elem2 = seqIter2.next();
  ...
  function genPairMergedSequences(firstSeq, secondSeq, seqIter, comp) {
    ...
    return regeneratorRuntime.wrap(function genPairMergedSequences$(context$1$0) {
      var _this2 = this;
  ...
  function genMergedAndSortedSequence(seqIter, comp) {
    ...
    return regeneratorRuntime.wrap(function genMergedAndSortedSequence$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          if (!true) {
            context$1$0.next = 11;
        ...
        case 4:
          ...
          return context$1$0.delegateYield(firstElem.value[Symbol.iterator](), 't0', 7);
  ...
  var keyOrValueIter2ValueIter = regeneratorRuntime.mark(function keyOrValueIter2ValueIter(keyOrValueIter) {
    var elem, keyOrVal;
    return regeneratorRuntime.wrap(function keyOrValueIter2ValueIter$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          elem = undefined;
  ...
  var orderByImpl = regeneratorRuntime.mark(function orderByImpl(seq, options) {
    ...
    return regeneratorRuntime.wrap(function orderByImpl$(context$1$0) {
      while (1) switch (context$1$0.prev = context$1$0.next) {
        case 0:
          if (!(options.length == 0)) {
            context$1$0.next = 2;
        ...
        case 2:
          ...
          if (!isKeyDefault) {
            ...
            keyOrValSeq = (_keyOrValSeq = {}, _keyOrValSeq[Symbol.iterator] = regeneratorRuntime.mark(function callee$1$0() {
              var _iterator2, _isArray2, _i2, _ref5, _ref4, val, key;

              return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
                while (1) switch (context$2$0.prev = context$2$0.next) {
                  case 0:
                    _iterator2 = seq, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();
  ...
  function joinImpl(_this, other, thisKeySelector, otherKeySelector, binaryTrans, equal, isGroupJoin) {
    ...
    return new Enumerable(regeneratorRuntime.mark(function callee$1$0() {
      ...
      return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            ...
            _iterator3 = _this, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();
          ...
          case 12:
            x = _ref6;
            _iterator4 = yGroups, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();
          ...
          case 34:
            _iterator5 = ySeq, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();
  ...
  var Enumerable = (function () {
    ...
    Enumerable.prototype._clone = function _clone() {
      var result = new Enumerable(this[Symbol.iterator], this._baseObject);
    ...
    Enumerable.prototype.skip = function skip(n) {
      ...
      var _this = this;
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              startYield = false;
              count = n;
              _iterator6 = _this, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              startYield = false;
              index = 0;
              _iterator7 = _this, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();
      ...
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              count = n;
              _iterator8 = _this, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator]();
      ...
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              index = 0;
              _iterator9 = _this, _isArray9 = Array.isArray(_iterator9), _i9 = 0, _iterator9 = _isArray9 ? _iterator9 : _iterator9[Symbol.iterator]();
      ...
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            ...
            case 5:
              buf = [];
              _iterator10 = _this, _isArray10 = Array.isArray(_iterator10), _i10 = 0, _iterator10 = _isArray10 ? _iterator10 : _iterator10[Symbol.iterator]();
      ...
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              index = 0;
              _iterator11 = _this, _isArray11 = Array.isArray(_iterator11), _i11 = 0, _iterator11 = _isArray11 ? _iterator11 : _iterator11[Symbol.iterator]();
      ...
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              index = 0;
              _iterator12 = _this, _isArray12 = Array.isArray(_iterator12), _i12 = 0, _iterator12 = _isArray12 ? _iterator12 : _iterator12[Symbol.iterator]();
      ...
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              index = 0;
              _iterator13 = _this, _isArray13 = Array.isArray(_iterator13), _i13 = 0, _iterator13 = _isArray13 ? _iterator13 : _iterator13[Symbol.iterator]();
            ...
            case 19:
              _iterator14 = seq, _isArray14 = Array.isArray(_iterator14), _i14 = 0, _iterator14 = _isArray14 ? _iterator14 : _iterator14[Symbol.iterator]();
          ...
          return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
            while (1) switch (context$3$0.prev = context$3$0.next) {
              case 0:
                ...
                _iterator15 = _this, _isArray15 = Array.isArray(_iterator15), _i15 = 0, _iterator15 = _isArray15 ? _iterator15 : _iterator15[Symbol.iterator]();
              ...
              case 8:
                _iterator16 = groups, _isArray16 = Array.isArray(_iterator16), _i16 = 0, _iterator16 = _isArray16 ? _iterator16 : _iterator16[Symbol.iterator]();
        ...
        return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
          ...
          return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
            while (1) switch (context$3$0.prev = context$3$0.next) {
              case 0:
                seqMap = new Map();
                _iterator17 = _this, _isArray17 = Array.isArray(_iterator17), _i17 = 0, _iterator17 = _isArray17 ? _iterator17 : _iterator17[Symbol.iterator]();
              ...
              case 19:
                _iterator18 = seqMap, _isArray18 = Array.isArray(_iterator18), _i18 = 0, _iterator18 = _isArray18 ? _iterator18 : _iterator18[Symbol.iterator]();
    ...
    Enumerable.prototype.orderBy = function orderBy(keySelector) {
      ...
      var _this = this;
      var result = new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        var iter;
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
    ...
    Enumerable.prototype.concat = function concat(other) {
      ...
      return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
        ...
        return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
          while (1) switch (context$3$0.prev = context$3$0.next) {
            case 0:
              _iterator19 = _this, _isArray19 = Array.isArray(_iterator19), _i19 = 0, _iterator19 = _isArray19 ? _iterator19 : _iterator19[Symbol.iterator]();
            ...
            case 16:
              _iterator20 = other, _isArray20 = Array.isArray(_iterator20), _i20 = 0, _iterator20 = _isArray20 ? _iterator20 : _iterator20[Symbol.iterator]();
        ...
        return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
          ...
          return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
            ...
            while (1) switch (context$3$0.prev = context$3$0.next) {
              case 0:
                generated = [];
                _loop2 = regeneratorRuntime.mark(function callee$3$0() {
                  var x;
                ...
                _iterator21 = _this, _isArray21 = Array.isArray(_iterator21), _i21 = 0, _iterator21 = _isArray21 ? _iterator21 : _iterator21[Symbol.iterator]();
        ...
        return new Enumerable(regeneratorRuntime.mark(function callee$2$0() {
          ...
          return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
            while (1) switch (context$3$0.prev = context$3$0.next) {
              case 0:
                valSet = new Set();
                _iterator22 = _this, _isArray22 = Array.isArray(_iterator22), _i22 = 0, _iterator22 = _isArray22 ? _iterator22 : _iterator22[Symbol.iterator]();
    ...
    Enumerable.prototype.all = function all(pred) {
      ...
      var index = 0;
      for (var _iterator23 = this, _isArray23 = Array.isArray(_iterator23), _i23 = 0, _iterator23 = _isArray23 ? _iterator23 : _iterator23[Symbol.iterator]();;) {
        var _ref26;
    ...
    Enumerable.prototype.any = function any() {
      ...
      var index = 0;
      for (var _iterator24 = this, _isArray24 = Array.isArray(_iterator24), _i24 = 0, _iterator24 = _isArray24 ? _iterator24 : _iterator24[Symbol.iterator]();;) {
        var _ref27;
    ...
    Enumerable.prototype.singleOrDefault = function singleOrDefault(pred, throwWhenNotFound) {
      ...
      var index = 0;
      for (var _iterator25 = this, _isArray25 = Array.isArray(_iterator25), _i25 = 0, _iterator25 = _isArray25 ? _iterator25 : _iterator25[Symbol.iterator]();;) {
        var _ref28;
    ...
    Enumerable.prototype.count = function count(pred) {
      ...
      var result = 0;
      for (var _iterator26 = this, _isArray26 = Array.isArray(_iterator26), _i26 = 0, _iterator26 = _isArray26 ? _iterator26 : _iterator26[Symbol.iterator]();;) {
        var _ref29;
    ...
    Enumerable.prototype.elementAtOrDefault = function elementAtOrDefault(index, throwWhenNotFound) {
      ...
      var currentIndex = 0;
      for (var _iterator27 = this, _isArray27 = Array.isArray(_iterator27), _i27 = 0, _iterator27 = _isArray27 ? _iterator27 : _iterator27[Symbol.iterator]();;) {
        var _ref30;
    ...
    Enumerable.prototype.firstOrDefault = function firstOrDefault(pred, throwWhenNotFound) {
      ...
      var index = 0;
      for (var _iterator28 = this, _isArray28 = Array.isArray(_iterator28), _i28 = 0, _iterator28 = _isArray28 ? _iterator28 : _iterator28[Symbol.iterator]();;) {
        var _ref31;
    ...
    Enumerable.prototype.lastOrDefault = function lastOrDefault(pred, throwWhenNotFound) {
      ...
      if (isDefaultPred) {
        var buf = undefined;
        var notEmpty = false;
        for (var _iterator29 = this, _isArray29 = Array.isArray(_iterator29), _i29 = 0, _iterator29 = _isArray29 ? _iterator29 : _iterator29[Symbol.iterator]();;) {
          var _ref32;
    ...
    Enumerable.prototype._minMaxImpl = function _minMaxImpl(keySelector, comp) {
      ...
      var index = 0;
      for (var _iterator30 = this, _isArray30 = Array.isArray(_iterator30), _i30 = 0, _iterator30 = _isArray30 ? _iterator30 : _iterator30[Symbol.iterator]();;) {
        var _ref33;
    ...
    Enumerable.prototype.sum = function sum() {
      ...
      var result = 0;
      var index = 0;
      for (var _iterator31 = this, _isArray31 = Array.isArray(_iterator31), _i31 = 0, _iterator31 = _isArray31 ? _iterator31 : _iterator31[Symbol.iterator]();;) {
        var _ref34;
    ...
    Enumerable.prototype.average = function average() {
      ...
      var count = 0;
      var index = 0;
      for (var _iterator32 = this, _isArray32 = Array.isArray(_iterator32), _i32 = 0, _iterator32 = _isArray32 ? _iterator32 : _iterator32[Symbol.iterator]();;) {
        var _ref35;
    ...
    Enumerable.prototype.toArray = function toArray() {
      var result = [];
      for (var _iterator33 = this, _isArray33 = Array.isArray(_iterator33), _i33 = 0, _iterator33 = _isArray33 ? _iterator33 : _iterator33[Symbol.iterator]();;) {
        var _ref36;
    ...
    Enumerable.prototype.toSet = function toSet() {
      var result = new Set();
      for (var _iterator34 = this, _isArray34 = Array.isArray(_iterator34), _i34 = 0, _iterator34 = _isArray34 ? _iterator34 : _iterator34[Symbol.iterator]();;) {
        var _ref37;
    ...
    Enumerable.prototype.toMap = function toMap(keySelector, valueSelector) {
      return new Map(this.select(function (x) {
    ...
    Enumerable.prototype.forEach = function forEach(op) {
      ...
      for (var _iterator35 = this, _isArray35 = Array.isArray(_iterator35), _i35 = 0, _iterator35 = _isArray35 ? _iterator35 : _iterator35[Symbol.iterator]();;) {
        var _ref38;
  ...
  function asEnumerable(obj) {
    ...
    return new Enumerable(regeneratorRuntime.mark(function callee$1$0() {
      return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            return context$2$0.delegateYield(obj[Symbol.iterator](), 't0', 1);
